import {
  ...
  registrationIdentityRows,
  registrationStampDate,
} from '../src/core/registration-pdf';

describe('registration PDF', () => {
  it('uses the current Nairobi calendar date for the generated-copy stamp', () => {
    expect(registrationStampDate(new Date('2026-09-14T22:30:00.000Z'))).toBe('15 SEP 2026');
  });
